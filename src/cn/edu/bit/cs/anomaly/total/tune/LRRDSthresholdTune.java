...
import cn.edu.bit.cs.anomaly.LRRDSthreshold;
...
public class LRRDSthresholdTune {
	...
	public static void main(String[] args) {
	    ...
	    try { 
	     ...
	     // check result file
	        String[] resultToks = {filePrefix, "exp", "lrrdsthreshold","compressed_rate", String.valueOf(compressed_rate), 
	        		"slack", String.valueOf(slack), "sub_minlength",String.valueOf(sub_minlength),"threshold",String.valueOf(threshold)};
	     ...
	     // run algorithm
	        LOGGER.info("run lrrdsthreshold: "+compressed_rate+" "+slack+" "+sub_minlength+" "+threshold);
	        Map<String,Object> params = new HashMap<>();
	        params.put("compressed_rate", compressed_rate);
	        params.put("slack", slack);
	        params.put("sub_minlength", sub_minlength);
	        params.put("threshold",threshold);
	        LRRDSthreshold lrrds = new LRRDSthreshold();
