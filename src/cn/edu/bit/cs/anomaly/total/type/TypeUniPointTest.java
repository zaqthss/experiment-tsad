...
public class TypeUniPointTest {
  ...
  public static void main(String[] args) throws ArgumentParserException {
    ...
    for (int index = 0; index < VARSIZE; ++index) {
      String rawPath = String.format("%s/%s_%s_%s_%s_", dir, filePrefix,vars[index], size,rate);
      ...
      // write results
      fh.writeResults("type", "uni-point-" + dsName, vars, algNames, metricNames, totaltime,
          metrics, seeds.size());
    } // end of rIndex
  }
}
